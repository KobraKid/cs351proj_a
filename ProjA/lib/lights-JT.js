...
// Constructor function:
	this.I_pos = new Vector4();	// x,y,z,w:   w==1 for local 3D position,
								// w==0 for light at infinity in direction (x,y,z)
	this.isLit = true;						// true/false for ON/OFF
	this.ambiOn = true;
	this.diffOn = true;
	this.specOn = true;
	this.I_ambi = new Vector3();		// ambient illumination: r,g,b
	this.I_diff = new Vector3();		// diffuse illumination: r,g,b.
	this.I_spec = new Vector3();		// specular illumination: r,g,b.
	//
	this.u_pos = false;						// GPU location for 'uniform' that holds I_pos
	this.u_ambi = false;						// 																			 I_ambi
	this.u_diff = false;						//																			 I_diff
	this.u_spec = false;						//																			 I_spec.
	this.u_isLit = false;
	this.u_ambiOn = false;
	this.u_diffOn = false;
	this.u_specOn = false;
